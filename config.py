...
CHALLENGE_SUBMITTED_ROLE_ID = int(os.environ.get("SUBMITTED_ROLE_ID"))
CHALLENGE_PARTICIPANT_ROLE_ID = int(os.environ.get("PARTICIPANT_ROLE_ID"))

INFO_CHANNEL_ID = int(os.environ.get("INFO_CHANNEL_ID"))
BOT_GAMES_CHANNEL_ID = int(os.environ.get("BOT_GAMES_CHANNEL_ID"))
CHALLENGE_SUBMIT_CHANNEL_ID = int(os.environ.get("SUBMIT_CHALLENGE_CHANNEL_ID"))