...
class Help(commands.HelpCommand):
    ...
    def embedify(self, title: str, description: str) -> discord.Embed:
        ...
        embed.set_footer(icon_url=self.context.bot.user.avatar.url, text=f"Called by: {self.context.author}")
        return embed
    ...
    async def send_command_help(self, command):
        ...
        try:
            ...
            if isinstance(error, commands.MissingPermissions):
                ...
                await self.context.bot.get_user(self.context.bot.owner_id).send(
