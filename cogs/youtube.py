...
class YouTube(commands.Cog):
    ...
    async def alert_webhook(self):
        ...
        embed = discord.Embed(title=data["title"], url=url, description=description, color=discord.Color.red())
    ...
    async def stats(self, ctx):
        ...
        data = self.data
        embed = discord.Embed(
            title=data["snippet"]["title"], description=data["snippet"]["description"], color=discord.Color.red()
        )
